...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen items-center justify-between p-6 bg-white shadow-lg rounded-lg"> {/* Adjust padding and add styles for the main container */}
